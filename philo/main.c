...
/*   Updated: 2022/07/15 23:57:34 by sguilher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[])
{
	...
	if (forks == NULL)
		return (E_MALLOC);
	philosopher_data = init_philosopher_data(number_of_philosophers, forks, argv);
	if (philosopher_data == NULL)
		return (E_MALLOC); // must clean
	philosophers = create_philosophers(number_of_philosophers, philosopher_data);
